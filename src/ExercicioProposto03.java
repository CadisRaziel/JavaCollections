...
public class ExercicioProposto03 {
    ...
    public static void main(String[] args) {
        ...
        //********************************************************************
        //CLASSE ANONIMA - FUNTION - LAMBDA

        System.out.println("--\tOrdem número telefone com classe anonima no comparator\t--");
        ...
        System.out.println("--\tOrdem número telefone com classe anonima no comparator usando o 'comparing com interface funcional (function)'\t--");
        ...
        System.out.println("--\tOrdem número telefone usando lambda'\t--");
        //repare que nao precisei instanciar a classe 'Contato'
        ...
        Set<Map.Entry<Integer, Contato>> set3 = new TreeSet<>(new ComparatorOrdemNomeContato());
